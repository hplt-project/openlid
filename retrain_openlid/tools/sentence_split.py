...
def get_split_algo(lang: str, split_algo: str = "default") -> tp.Callable[[str], tp.Iterable[str]]:
    ...
    elif split_algo == "olchiki":
        logger.info(f" - Olchiki rule-based sentence splitter applied to '{lang}'")
        return split_olchiki
